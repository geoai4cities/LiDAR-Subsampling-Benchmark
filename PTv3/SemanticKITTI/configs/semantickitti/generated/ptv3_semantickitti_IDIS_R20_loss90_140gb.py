...
experiment = dict(
    name="ptv3_semantickitti_IDIS_R20_loss90_140gb",
    seed=42,
)

# Data root - WILL BE REPLACED BY GENERATE SCRIPT
data_root = "../../data/SemanticKITTI/subsampled/IDIS_R20_loss90"
...
wandb = dict(
    ...
    name="ptv3_semantickitti_IDIS_R20_loss90_140gb",
    entity=None,
    tags=["semantickitti", "h200-140gb", "ptv3", "IDIS_R20", "loss90"],
)
