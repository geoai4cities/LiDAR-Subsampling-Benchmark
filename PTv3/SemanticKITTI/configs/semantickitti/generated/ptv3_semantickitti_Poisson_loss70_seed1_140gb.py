...
experiment = dict(
    name="ptv3_semantickitti_Poisson_loss70_seed1_140gb",
    seed=1,
)

# Data root - WILL BE REPLACED BY GENERATE SCRIPT
data_root = "../../data/SemanticKITTI/subsampled/Poisson_loss70_seed1"
...
wandb = dict(
    ...
    name="ptv3_semantickitti_Poisson_loss70_seed1_140gb",
    entity=None,
    tags=["semantickitti", "h200-140gb", "ptv3", "Poisson", "loss70"],
)
