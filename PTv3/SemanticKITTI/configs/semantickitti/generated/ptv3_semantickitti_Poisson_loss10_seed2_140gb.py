...
experiment = dict(
    name="ptv3_semantickitti_Poisson_loss10_seed2_140gb",
    seed=2,
)

# Data root - WILL BE REPLACED BY GENERATE SCRIPT
data_root = "../../data/SemanticKITTI/subsampled/Poisson_loss10_seed2"
...
wandb = dict(
    ...
    name="ptv3_semantickitti_Poisson_loss10_seed2_140gb",
    entity=None,
    tags=["semantickitti", "h200-140gb", "ptv3", "Poisson", "loss10"],
)
